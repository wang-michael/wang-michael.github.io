...
**操作系统使用schedule函数来调度线程，大概流程是cpu响应时钟中断，由操作系统调用相应的中断处理程序来进行调度。执行schedule函数的线程是操作系统中专门负责处理进程调度的内核线程还是与响应中断之前正在执行的轻量级进程绑定的内核线程？？？**
...
参考文章：[Java线程和操作系统线程的关系](https://blog.csdn.net/cringkong/article/details/79994511)
